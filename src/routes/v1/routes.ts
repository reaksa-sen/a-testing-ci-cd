...
const models: TsoaRoute.Models = {
    ...
    "Partial_IUser_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"_id":{"dataType":"string"},"name":{"dataType":"string"},"gender":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["male"]},{"dataType":"enum","enums":["female"]},{"dataType":"enum","enums":["other"]}]},"age":{"dataType":"double"},"email":{"dataType":"string"},"image":{"dataType":"string"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
    ...
    // ###########################################################################################################
        ...
        app.post('/v1/users',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    ...
                    age: {"in":"formData","name":"age","required":true,"dataType":"string"},
                    gender: {"in":"formData","name":"gender","required":true,"dataType":"string"},
